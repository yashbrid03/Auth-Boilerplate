...
export const Profile = () => {
  ...
  const updateProfile = async (e) =>{
    ...
    try{
      ...
      if(number>=1111111111 && number <= 9999999999){
        const response = await api.put('/auth/updateUserDetails',{name,number})
  ...
  const deleteProfile = async () =>{
    try{
      ...
      if(confirm1){
        const response = await api.delete(`/auth/removeUser/${id}`)
  ...
  <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
      ...
      <form onSubmit={updateProfile}>
          ...
          <div class="flex items-center space-x-4">
              ...
              <button type="button" onClick={deleteProfile} class="text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
